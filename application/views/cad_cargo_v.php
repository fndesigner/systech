...
<html>
<head>
<title><?= $titulo ?> - Cadastro de Cargo</title>
...
<body>
    ...
    <form action="<?= base_url().'salvar/cargo/cadastro' ?>" method="post" class="formee" id="formcargo" >
	    <div class="content container_12">
			...
			<div class="grid_12">Cargo: <em class="formee-req">*</em></div>
    		<div class="grid_6"><input type="text" value="" name="cargo" /></div>
