...
<html>
<head>
<title><?= $titulo ?> - Cadastro de Marca</title>
...
<body>
    ...
    <form action="<?= base_url().'salvar/marca/cadastro' ?>" method="post" class="formee" id="formmarca" >
	    <div class="content container_12">
			<div class="box-head"><h2>Cadastro de Marca</h2></div>
			<div class="box-content box">
			<? if($this->session->flashdata('msg_ok')==1) { ?> <div class="formee-msg-success"><h3>Cadastro efetuado.</h3></div><? } ?>
			<div class="grid_12">Marca: <em class="formee-req">*</em></div>
    		<div class="grid_6"><input type="text" value="" name="marca" /></div>
